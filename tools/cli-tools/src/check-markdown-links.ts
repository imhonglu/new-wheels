...
/**
 * Finds local Markdown links whose target is missing or has different casing.
 *
 * @throws If no input is provided or an input path does not exist.
 */
export function findBrokenMarkdownLinks(inputs: readonly string[]): string[] {
  if (inputs.length === 0) {
