...
- [@imhonglu/json-schema-typed](./libs/json-schema-typed/README_KR.md)
  JSON Schema를 타입 안전하게 정의하고 인스턴스 타입을 추론하는 도구입니다.
  **컴파일 타임 스키마 검사와 스키마 기반 TypeScript 타입을 제공합니다.**
