...
```typescript
export declare function createSchemaClass<const T extends SchemaInput>(schemaDefinition: InferSchema<T>): SchemaClass<T> & Schema<T>;
```
...
[SchemaClass](./json-schema.schemaclass.md)<!-- -->&lt;T&gt; &amp; [Schema](./json-schema.schema.md)<!-- -->&lt;T&gt;
